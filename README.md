...
```
キーワードと画像アドレスの数を増やせば上記のように大量のCGを管理する事も出来ます<br>
<br>
...
# キャラを自作して配布しよう
①right_nav_kai（キャラ選択画像）と②image_display（画像自動切り替え）をSillyTavernの機能と組み合わせて<br>
自作したキャラの（JSON＋画像ファイル）をZIPでまとめて配布しましょう<br>
<br>
まずキャラクター管理パネルを開いて新規キャラ作成アイコンをクリックします
![](https://files.catbox.moe/p56lmv.png)<br>
<br>
適当に記入します
![](https://files.catbox.moe/ecniks.png)<br>
<br>
入力が終わったらキャラ作成ボタンを押します
![](https://files.catbox.moe/wtlfgx.png)<br>
<br>
キャラが追加されましたが、キャラ選択画像は設定されていません
![](https://files.catbox.moe/nomm84.png)<br>
<br>
...
![](https://files.catbox.moe/67g37f.png)<br>
<br>
全てのファイルを「キャラクター名」フォルダにまとめてZIPで圧縮して完成です<br>
![](https://files.catbox.moe/kexpj5.png)<br>
<br>
掲示板など配布すればユーザーは解凍して「addchara」フォルダに入れてインポートするだけです<br>
# ユーザーがやるべきこと<br>
ユーザーはダウンロードしたZIPファイルを解凍してフォルダごと「addchara」フォルダにいれます<br>
フォルダ構成は　**public/addchara/ダウンロードしたキャラ名のフォルダ**　になるはずです<br>
...
![](https://files.catbox.moe/jasu5b.png)<br>
<br>
