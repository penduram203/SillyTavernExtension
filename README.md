...
画面左下に殆ど透明なボタンがあります<br>
<br>
![](https://i.imgur.com/0M7G84N.png)<br>
左下のボタンを押す度に「UTモード」と「AIモード」が切り替わります<br>
UTモードではユーザーが入力したテキストのみを元に判断して画像を切り替え<br>
AIモードではAIが生成したテキストのみを元に判断して画像を切り替えます<br>
...
![](https://i.imgur.com/gCweaoN.png)<br>
<br>
### 画像マッピング<br>
...
「or」は「AかBのどちらか」という条件です
例えばキーワード設定で「車or自動車」とすると
チャット欄に「車」か「自動車」という単語が出てくると反応します
「車で出掛けた」とか「自動車が見える」とかいう文章に反応して画像が切り替わります

「and」は「AとBのどちらも」という条件です
例えばキーワード設定で「犬and猫」とすると
チャット欄に「犬」と「猫」という単語が両方同時に出てくると反応します
「犬と猫を飼っている」とか「犬も猫も好き」とかいう文章で画像が切り替わります
...
関連したアドレスの画像が画像表示ウインドウに表示されます<br>
# キャラクターの配布<br>
